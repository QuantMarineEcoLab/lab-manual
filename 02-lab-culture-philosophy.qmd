...
The lab primarily uses Sharepoint. We use
Sharepoint for large file storage and backing up data. Sometimes, we use Google
...
preference for document preparation is a combination of R markdown (or Quarto) and
Github.
